...
<div class="blog-post well">
	...
	<div style="display: inline; width: 20%; background: white; padding: 10px; border-radius: 5px;">
		<a href="/posts/{{$post->id}}/delete" @click = "deletePost($event, {{$post->id}})"><span style="padding: 10px" class="glyphicon glyphicon-trash"></span></a>
		<a href="/posts/{{$post->id}}/edit"><span style="padding: 10px; " class="glyphicon glyphicon-pencil"></span></a>
	</div>
